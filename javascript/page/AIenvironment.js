...
function saveLocal() {
  ...
  localStorage.setItem("chatMessages__AIenvironment", JSON.stringify(messages));
  localStorage.setItem("chatHistory__AIenvironment", JSON.stringify(chatHistory));
}

// ===== LOAD LOCAL =====
const savedMessages = JSON.parse(localStorage.getItem("chatMessages__AIenvironment")) || [];
const savedHistory = JSON.parse(localStorage.getItem("chatHistory__AIenvironment"));
...
if (clearBtn) {
  clearBtn.onclick = () => {
    ...
    localStorage.removeItem("chatHistory__AIenvironment");
    localStorage.removeItem("chatMessages__AIenvironment");
